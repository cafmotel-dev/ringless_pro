...
@section('content')
    ...
    <div class="page-wrapper"> 
        ...
        <div class="page-content">
            <!-- FAQ -->
            <section class="section-lgx section-faq">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="pbmit-heading-subheading text-center">
                                <!-- <h4 class="pbmit-subtitle-white">GENERAL QUESTIONS</h4> -->
                                <h2 class="pbmit-title">Privacy Policy</h2>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <!-- <p>Updated September 28, 2017</p> -->
                            <div>
                                ...
                                <p>
                                    ...
                                    encryption. We have implemented physical, electronic, and
                                    managerial protocols to prevent unauthorized access, ensure
                                    data security, and appropriately utilize the information
                                    collected online. All submitted information is protected by
                                    our secure server, employing automatic encryption of your
                                    personally identifiable details, preventing unauthorized
                                    access during transmission over the Internet.
                                </p>
                            </div>
                            <div>
                                ...
                                <p>
                                    ...
                                    control to modify, add, or delete any phone numbers within
                                    ...
                                    method if you choose to stop receiving updates.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p>
                                    To enhance your experience with our website, we use
                                    "cookies." Cookies are used by your computer's browser to
                                    store your preferences. Cookies, by themselves, do not tell
                                    us your email address or other personally identifiable
                                    information unless you choose to provide this information to
                                    us.
                                </p>
                            </div>
                            <div>
                                <h5>Share Ringless Pro</h5>
                                <p>
                            ...
                            <div>
                                ...
                                <p>
                                    ...
                                    <a href="{{url('contact-us')}}">contact us</a> . Your security and the
                                    security of your data, is of paramount importance to us.
                                </p>
                            </div>
                        </div>
                    </div>
